...
<%@ page import="java.sql.*,com.akhil.beans.*,com.akhil.dao.*" %>    
          ...
          <table border="0">
            ...
            <tr><td>Picture</td><td>
            	<img src="./ShowImage?pid=<%=product.getProdId() %>" alt="Product Image" width="200px" height="200px"/></td></tr>
                        <tr><td><br></td><td><br></td></tr>
            <tr colspan="2" align="center"><td><button><a href="adminViewProduct.jsp">Cancel</a></button>&nbsp;</td>
            			<td><input type="submit" class="button"name="submit" value="Update Product"></td></tr>
